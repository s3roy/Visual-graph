  ...
  return (
    <Stack height="100vh" borderRight="1px" width="15vw">
      ...
      <Stack direction="row">
        ...
        <Text fontSize="sm" padding="3">Apps & Pages</Text>
        <div>
        <Stack spacing={2}>
        <Link>
            <Box display="flex" alignItems="center" cursor="pointer" paddingLeft="10px" _hover={{ border: '1px solid blue', borderRadius: '4px' }}>
